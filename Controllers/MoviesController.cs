...
namespace MvcMovie.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Index(string movieGenre, string searchString, int? selectedYear)
        {
            ...
            // Use LINQ to get list of genres and years.
            ...
            {
                var yearStart = new DateTime(selectedYear.Value, 1, 1);
                movies = movies.Where(m => m.ReleaseDate >= yearStart);
            }

            var years = await yearQuery.Distinct().ToListAsync();
